    ...
    <div class="footer-container">
        ...
        <nav class="footer-right">
            <ul class="footer-medias">
                ...
                <li class="footer-item">
                    <a href="https://www.youtube.com/channel/UCd2z3FXc8uPNspFEGYnYTFQ" class="footer-link">
            ...
            <ul class="footer-nav">
                ...
                <li class="footer-item"><a href="/confidentialite" class="footer-link">Confidentialité</a></li>
                <li class="footer-item"><a href="/apropos" class="footer-link">A propos</a></li>
